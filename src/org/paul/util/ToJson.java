 ...
 * class requires the ESAPI 1.4.5 jar file ESAPI is used to encode data
 *
 * @author 308tube
 */
public class ToJson {
	/**
	 * This will convert parts records into a JSON Array Simply pass in a
	 * array list of parts and it will loop return a JSON array.
	 * 
	 * @param parts
	 * @return - JSON array
	 * @throws Exception

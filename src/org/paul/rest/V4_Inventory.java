...
public class V4_Inventory {
	 ...
	 * example of using JSONArray and JSONObject
	 * 
	 * Note: This is apart of the Jersey version 1 but I'm not sure if its apart
	 * of the version 2 Jersey. Go to http://json.org/java/ if you need the
	 * source files.
	 * 
	 * @param incomingData
	 * @return
	...
	public Response addPcParts2(String incomingData) throws Exception {
		...
		try {
			 ...
			 * exist.
			 */
			int http_code = dao.insertIntoPC_PARTS(partsData.optString("PC_PARTS_TITLE"), partsData.optString("PC_PARTS_CODE"), partsData.optString("PC_PARTS_MAKER"), partsData.optString("PC_PARTS_AVAIL"), partsData.optString("PC_PARTS_DESC"));
			if (http_code == 200) {
				/*
				...
				jsonObject.put("MSG", "Item has been entered successfully, Version 4");
				/*
	...
	@Consumes({MediaType.APPLICATION_FORM_URLENCODED,MediaType.APPLICATION_JSON})
	@Produces(MediaType.APPLICATION_JSON)
	public Response updateItem(@PathParam("brand") String brand, @PathParam("item_number") int item_number, String incomingData) throws Exception {
	...
	@Consumes({MediaType.APPLICATION_FORM_URLENCODED,MediaType.APPLICATION_JSON})
	@Produces(MediaType.APPLICATION_JSON)
	public Response deleteItem(@PathParam("brand") String brand, @PathParam("item_number") int item_number, String incomingData) throws Exception {
